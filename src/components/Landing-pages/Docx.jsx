...
export default function Document() {
  ...
  return (
    <div>
          ...
          <div className="min-h-screen bg-gray-100 text-gray-800">
            <div className=" w-[90%]  mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 lg:gap-6 ">
                ...
                <div className="pt-24 lg:col-span-1 col-span-4 block lg:sticky lg:top-0 h-auto lg:h-screen ">
                  <div className=" mb-4">
                    ...
                    <ul className={` pt-0 md:pt-24 space-y-4 mt-4 ${isOpen ? "block" : "hidden"} lg:block`}>
                      <li>
                        <button
                          onClick={() => {
                ...
                <div className=" pt-0 md:pt-24 md:col-span-3 overflow-auto max-h-screen [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] pb-8 bg-white ">
      ...
      >
        <img
          src="https://colorlib.com/wp/wp-content/uploads/sites/2/colorlib-reg-form-36.jpg"
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 rounded-xl opacity-0 hover:opacity-100 transition-opacity duration-300">
          <button className="bg-white text-blue-600 px-6 py-2 rounded-full font-semibold shadow-lg hover:bg-blue-600 hover:text-white transition-all">
            Scan Me
          </button>
        </div>
      </motion.div>
                            ...
                            {steps.map((step, index) => (
                              ...
                              >
                                ...
                                <img
                                  src={step.imgSrc}
                                  alt={step.alt}
                                  className="  lg:w-[500px] lg:h-[300px] object-cover rounded-md transform group-hover:scale-105 transition-transform duration-300"
                                />
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="lg:p-6 p-3 bg-white rounded-lg ">
                      ...
                      <div className="flex justify-center">
                        <motion.img
                          src="https://ik.imagekit.io/pds5n5l6d3/LogicQR/Home%20page%20Assets/Dashboard%20img?updatedAt=1741521125672"
                          alt="Dashboard "
                          className="max-w-full md:h-[450px] rounded-lg shadow-lg"
